...
static void fts_get_upgrade_info(struct Upgrade_Info *upgrade_info)
{
	...
	case 0x55:    //IC_FT5X06:
		...
		break;
	case 0x08:    //IC_FT5606\BB\F2\D5\DFIC_FT5506
...
E_UPGRADE_ERR_TYPE  ft5x06_ctpm_fw_upgrade(u8* pbt_buf, u16 dw_lenth)
{
	...
	fts_get_upgrade_info(&upgradeinfo);
        ...
        //delay_ms(100);//\D7\EE\D0µ\C4Դ\C2\EBȥ\B5\F4\D1\D3ʱ
	...
	cmd_write(0x63,0x00,0x00,0x00,1);
        ...
        /*send the opration head*/
        //cmd_write(0xcc,0x00,0x00,0x00,1);//\B0\D10xcc\B5\B1\D7\F7\BCĴ\E6\C6\F7\B5\D8ַ\A3\ACȥ\B6\C1\B3\F6һ\B8\F6\D7ֽ\DA
