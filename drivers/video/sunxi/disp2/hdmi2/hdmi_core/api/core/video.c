...
void videoParams_SetYcc420Support(hdmi_tx_dev_t *dev,
			dtd_t *paramsDtd, shortVideoDesc_t *paramsSvd)
{
	...
	HDMI_INFO_MSG("set Paramssvd->limite %d\n",
				paramsSvd->mLimitedToYcc420);
	HDMI_INFO_MSG("set ParamsSvd->supports %d\n", paramsSvd->mYcc420);
}
