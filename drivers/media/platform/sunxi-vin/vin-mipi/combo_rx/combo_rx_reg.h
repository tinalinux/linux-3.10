...
enum lvds_inter_lane0_map {
	...
	LVDS_IN_L0_USE_PAD_LANE0     = 0x1,
	LVDS_IN_L0_USE_PAD_LANE1     = 0x2,
	LVDS_IN_L0_USE_PAD_LANE2     = 0x3,
	LVDS_IN_L0_USE_PAD_LANE3     = 0x4,
	LVDS_IN_L0_USE_PAD_LANE4     = 0x5,
	LVDS_IN_L0_USE_PAD_LANE5     = 0x6,
	LVDS_IN_L0_USE_PAD_LANE6     = 0x7,
	LVDS_IN_L0_USE_PAD_LANE7     = 0x8,
	LVDS_IN_L0_USE_PAD_LANE8     = 0x9,
	LVDS_IN_L0_USE_PAD_LANE9     = 0x10,
	LVDS_IN_L0_USE_PAD_LANE10     = 0x11,
	LVDS_IN_L0_USE_PAD_LANE11     = 0x12,
};

enum lvds_inter_lane1_map {
	LVDS_LANE1_NO_USE            = 0x0,
	LVDS_IN_L1_USE_PAD_LANE0     = 0x1,
	LVDS_IN_L1_USE_PAD_LANE1     = 0x2,
	LVDS_IN_L1_USE_PAD_LANE2     = 0x3,
	LVDS_IN_L1_USE_PAD_LANE3     = 0x4,
	LVDS_IN_L1_USE_PAD_LANE4     = 0x5,
	LVDS_IN_L1_USE_PAD_LANE5     = 0x6,
	LVDS_IN_L1_USE_PAD_LANE6     = 0x7,
	LVDS_IN_L1_USE_PAD_LANE7     = 0x8,
	LVDS_IN_L1_USE_PAD_LANE8     = 0x9,
	LVDS_IN_L1_USE_PAD_LANE9     = 0x10,
	LVDS_IN_L1_USE_PAD_LANE10     = 0x11,
	LVDS_IN_L1_USE_PAD_LANE11     = 0x12,
};

enum lvds_inter_lane2_map {
	LVDS_LANE2_NO_USE            = 0x0,
	LVDS_IN_L2_USE_PAD_LANE0     = 0x1,
	LVDS_IN_L2_USE_PAD_LANE1     = 0x2,
	LVDS_IN_L2_USE_PAD_LANE2     = 0x3,
	LVDS_IN_L2_USE_PAD_LANE3     = 0x4,
	LVDS_IN_L2_USE_PAD_LANE4     = 0x5,
	LVDS_IN_L2_USE_PAD_LANE5     = 0x6,
	LVDS_IN_L2_USE_PAD_LANE6     = 0x7,
	LVDS_IN_L2_USE_PAD_LANE7     = 0x8,
	LVDS_IN_L2_USE_PAD_LANE8     = 0x9,
	LVDS_IN_L2_USE_PAD_LANE9     = 0x10,
	LVDS_IN_L2_USE_PAD_LANE10     = 0x11,
	LVDS_IN_L2_USE_PAD_LANE11     = 0x12,
};

enum lvds_inter_lane3_map {
	LVDS_LANE3_NO_USE            = 0x0,
	LVDS_IN_L3_USE_PAD_LANE0     = 0x1,
	LVDS_IN_L3_USE_PAD_LANE1     = 0x2,
	LVDS_IN_L3_USE_PAD_LANE2     = 0x3,
	LVDS_IN_L3_USE_PAD_LANE3     = 0x4,
	LVDS_IN_L3_USE_PAD_LANE4     = 0x5,
	LVDS_IN_L3_USE_PAD_LANE5     = 0x6,
	LVDS_IN_L3_USE_PAD_LANE6     = 0x7,
	LVDS_IN_L3_USE_PAD_LANE7     = 0x8,
	LVDS_IN_L3_USE_PAD_LANE8     = 0x9,
	LVDS_IN_L3_USE_PAD_LANE9     = 0x10,
	LVDS_IN_L3_USE_PAD_LANE10     = 0x11,
	LVDS_IN_L3_USE_PAD_LANE11     = 0x12,
};

enum lvds_inter_lane4_map {
	LVDS_LANE4_NO_USE            = 0x0,
	LVDS_IN_L4_USE_PAD_LANE0     = 0x1,
	LVDS_IN_L4_USE_PAD_LANE1     = 0x2,
	LVDS_IN_L4_USE_PAD_LANE2     = 0x3,
	LVDS_IN_L4_USE_PAD_LANE3     = 0x4,
	LVDS_IN_L4_USE_PAD_LANE4     = 0x5,
	LVDS_IN_L4_USE_PAD_LANE5     = 0x6,
	LVDS_IN_L4_USE_PAD_LANE6     = 0x7,
	LVDS_IN_L4_USE_PAD_LANE7     = 0x8,
	LVDS_IN_L4_USE_PAD_LANE8     = 0x9,
	LVDS_IN_L4_USE_PAD_LANE9     = 0x10,
	LVDS_IN_L4_USE_PAD_LANE10     = 0x11,
	LVDS_IN_L4_USE_PAD_LANE11     = 0x12,
};

enum lvds_inter_lane5_map {
	LVDS_LANE5_NO_USE            = 0x0,
	LVDS_IN_L5_USE_PAD_LANE0     = 0x1,
	LVDS_IN_L5_USE_PAD_LANE1     = 0x2,
	LVDS_IN_L5_USE_PAD_LANE2     = 0x3,
	LVDS_IN_L5_USE_PAD_LANE3     = 0x4,
	LVDS_IN_L5_USE_PAD_LANE4     = 0x5,
	LVDS_IN_L5_USE_PAD_LANE5     = 0x6,
	LVDS_IN_L5_USE_PAD_LANE6     = 0x7,
	LVDS_IN_L5_USE_PAD_LANE7     = 0x8,
	LVDS_IN_L5_USE_PAD_LANE8     = 0x9,
	LVDS_IN_L5_USE_PAD_LANE9     = 0x10,
	LVDS_IN_L5_USE_PAD_LANE10     = 0x11,
	LVDS_IN_L5_USE_PAD_LANE11     = 0x12,
};

enum lvds_inter_lane6_map {
	LVDS_LANE6_NO_USE            = 0x0,
	LVDS_IN_L6_USE_PAD_LANE0     = 0x1,
	LVDS_IN_L6_USE_PAD_LANE1     = 0x2,
	LVDS_IN_L6_USE_PAD_LANE2     = 0x3,
	LVDS_IN_L6_USE_PAD_LANE3     = 0x4,
	LVDS_IN_L6_USE_PAD_LANE4     = 0x5,
	LVDS_IN_L6_USE_PAD_LANE5     = 0x6,
	LVDS_IN_L6_USE_PAD_LANE6     = 0x7,
	LVDS_IN_L6_USE_PAD_LANE7     = 0x8,
	LVDS_IN_L6_USE_PAD_LANE8     = 0x9,
	LVDS_IN_L6_USE_PAD_LANE9     = 0x10,
	LVDS_IN_L6_USE_PAD_LANE10     = 0x11,
	LVDS_IN_L6_USE_PAD_LANE11     = 0x12,
};

enum lvds_inter_lane7_map {
	LVDS_LANE7_NO_USE            = 0x0,
	LVDS_IN_L7_USE_PAD_LANE0     = 0x1,
	LVDS_IN_L7_USE_PAD_LANE1     = 0x2,
	LVDS_IN_L7_USE_PAD_LANE2     = 0x3,
	LVDS_IN_L7_USE_PAD_LANE3     = 0x4,
	LVDS_IN_L7_USE_PAD_LANE4     = 0x5,
	LVDS_IN_L7_USE_PAD_LANE5     = 0x6,
	LVDS_IN_L7_USE_PAD_LANE6     = 0x7,
	LVDS_IN_L7_USE_PAD_LANE7     = 0x8,
	LVDS_IN_L7_USE_PAD_LANE8     = 0x9,
	LVDS_IN_L7_USE_PAD_LANE9     = 0x10,
	LVDS_IN_L7_USE_PAD_LANE10     = 0x11,
	LVDS_IN_L7_USE_PAD_LANE11     = 0x12,
};

enum lvds_inter_lane8_map {
	LVDS_LANE8_NO_USE            = 0x0,
	LVDS_IN_L8_USE_PAD_LANE0     = 0x1,
	LVDS_IN_L8_USE_PAD_LANE1     = 0x2,
	LVDS_IN_L8_USE_PAD_LANE2     = 0x3,
	LVDS_IN_L8_USE_PAD_LANE3     = 0x4,
	LVDS_IN_L8_USE_PAD_LANE4     = 0x5,
	LVDS_IN_L8_USE_PAD_LANE5     = 0x6,
	LVDS_IN_L8_USE_PAD_LANE6     = 0x7,
	LVDS_IN_L8_USE_PAD_LANE7     = 0x8,
	LVDS_IN_L8_USE_PAD_LANE8     = 0x9,
	LVDS_IN_L8_USE_PAD_LANE9     = 0x10,
	LVDS_IN_L8_USE_PAD_LANE10     = 0x11,
	LVDS_IN_L8_USE_PAD_LANE11     = 0x12,
};

enum lvds_inter_lane9_map {
	LVDS_LANE9_NO_USE            = 0x0,
	LVDS_IN_L9_USE_PAD_LANE0     = 0x1,
	LVDS_IN_L9_USE_PAD_LANE1     = 0x2,
	LVDS_IN_L9_USE_PAD_LANE2     = 0x3,
	LVDS_IN_L9_USE_PAD_LANE3     = 0x4,
	LVDS_IN_L9_USE_PAD_LANE4     = 0x5,
	LVDS_IN_L9_USE_PAD_LANE5     = 0x6,
	LVDS_IN_L9_USE_PAD_LANE6     = 0x7,
	LVDS_IN_L9_USE_PAD_LANE7     = 0x8,
	LVDS_IN_L9_USE_PAD_LANE8     = 0x9,
	LVDS_IN_L9_USE_PAD_LANE9     = 0x10,
	LVDS_IN_L9_USE_PAD_LANE10     = 0x11,
	LVDS_IN_L9_USE_PAD_LANE11     = 0x12,
};

enum lvds_inter_lane10_map {
	LVDS_LANE10_NO_USE            = 0x0,
	LVDS_IN_L10_USE_PAD_LANE0     = 0x1,
	LVDS_IN_L10_USE_PAD_LANE1     = 0x2,
	LVDS_IN_L10_USE_PAD_LANE2     = 0x3,
	LVDS_IN_L10_USE_PAD_LANE3     = 0x4,
	LVDS_IN_L10_USE_PAD_LANE4     = 0x5,
	LVDS_IN_L10_USE_PAD_LANE5     = 0x6,
	LVDS_IN_L10_USE_PAD_LANE6     = 0x7,
	LVDS_IN_L10_USE_PAD_LANE7     = 0x8,
	LVDS_IN_L10_USE_PAD_LANE8     = 0x9,
	LVDS_IN_L10_USE_PAD_LANE9     = 0x10,
	LVDS_IN_L10_USE_PAD_LANE10     = 0x11,
	LVDS_IN_L10_USE_PAD_LANE11     = 0x12,
};

enum lvds_inter_lane11_map {
	LVDS_LANE11_NO_USE            = 0x0,
	LVDS_IN_L11_USE_PAD_LANE0     = 0x1,
	LVDS_IN_L11_USE_PAD_LANE1     = 0x2,
	LVDS_IN_L11_USE_PAD_LANE2     = 0x3,
	LVDS_IN_L11_USE_PAD_LANE3     = 0x4,
	LVDS_IN_L11_USE_PAD_LANE4     = 0x5,
	LVDS_IN_L11_USE_PAD_LANE5     = 0x6,
	LVDS_IN_L11_USE_PAD_LANE6     = 0x7,
	LVDS_IN_L11_USE_PAD_LANE7     = 0x8,
	LVDS_IN_L11_USE_PAD_LANE8     = 0x9,
	LVDS_IN_L11_USE_PAD_LANE9     = 0x10,
	LVDS_IN_L11_USE_PAD_LANE10     = 0x11,
	LVDS_IN_L11_USE_PAD_LANE11     = 0x12,
};
...
struct lvds_lane_sof {
	unsigned int  high_bit;
	unsigned int  low_bit;
};
struct lvds_lane_sol {
	unsigned int  high_bit;
	unsigned int  low_bit;
};
struct lvds_lane_eol {
	unsigned int  high_bit;
	unsigned int  low_bit;
};
struct lvds_lane_eof {
	unsigned int  high_bit;
	unsigned int  low_bit;
};

struct lvds_sync_code {
	struct lvds_lane_sof lvds_lane_sof[12];
	struct lvds_lane_eof lvds_lane_eof[12];
	struct lvds_lane_sol lvds_lane_sol[12];
	struct lvds_lane_eol lvds_lane_eol[12];
};
...
void cmb_rx_lvds_mapping(unsigned int sel, struct lvds_lane_map *lvds_map);

void cmb_rx_lvds_sync_code(unsigned int sel, struct lvds_sync_code *lvds_sync_code);
