...
void cmb_rx_phya_config(unsigned int sel)
{
	...
	vin_reg_clr_set(cmb_rx_base_addr[sel] + CMB_PHYA_CTR_REG_OFF,
		CMB_PHYA_CKIN_MODE_SEL_MASK, 0 << CMB_PHYA_CKIN_MODE_SEL);
	vin_reg_clr_set(cmb_rx_base_addr[sel] + CMB_PHYA_CTR_REG_OFF,
		CMB_PHYA_BIT_SEL_MASK, 2 << CMB_PHYA_BIT_SEL);
	vin_reg_clr_set(cmb_rx_base_addr[sel] + CMB_PHYA_CTR_REG_OFF,
		CMB_PHYA_OUT_CLK_POL_MASK, 0 << CMB_PHYA_OUT_CLK_POL);
	vin_reg_clr_set(cmb_rx_base_addr[sel] + CMB_PHYA_CTR_REG_OFF,
	...
	vin_reg_clr_set(cmb_rx_base_addr[sel] + CMB_PHYA_CTR_REG_OFF,
		CMB_PHYA_OFFSET_SEL_MASK, 0 << CMB_PHYA_OFFSET_SEL);
	vin_reg_clr_set(cmb_rx_base_addr[sel] + CMB_PHYA_CTR_REG_OFF,
